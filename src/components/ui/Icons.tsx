...
export const IconTouch = (p: P) => (
  <svg {...base(p)}>
    <path d="M9 11.4V6.2a1.8 1.8 0 0 1 3.6 0v4.6" />
    <path d="M12.6 10.6V9.2a1.7 1.7 0 0 1 3.4 0v1.6" />
    <path d="M16 10.9V10a1.7 1.7 0 0 1 3.4 0v4.6a6.4 6.4 0 0 1-6.4 6.4h-1.3a5.4 5.4 0 0 1-4.3-2.1L5 15.2a1.7 1.7 0 0 1 2.6-2.1L9 14.6" />
    <path d="M4.4 4.4 3.2 3.2M8.4 3V1.6M12.6 4.4l1.2-1.2" />
  </svg>
);
